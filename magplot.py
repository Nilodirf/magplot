...
def highflu(fsz, txtx):
    ...
    ###NICKEL TEMP###
    pics[3].plot(ntc[2][0], ntc[2][1], color=colors[0], lw=3.0)
    pics[3].plot(ntc[3][0], ntc[3][1], color=colors[2], lw=3.0)
    pics[3].plot(ntc[4][0], ntc[4][1], color=colors[6], lw=3.0)
    pics[3].scatter(np.array(n3td[0]), n3td[1], color=colors[0], s=10)
    pics[3].scatter(n4td[0], n4td[1], color=colors[2], s=10)
    pics[3].scatter(n5td[0], n5td[1], color=colors[6], s=10)
    pics[3].annotate(r'1108', (txtx, 330), fontsize=fsz, color=colors[6])
    pics[3].annotate(r'605', (txtx, 295), fontsize=fsz, color=colors[2])
    pics[3].annotate(r'332', (txtx, 260), fontsize=fsz, color=colors[0])
    pics[3].annotate(r'$\frac{\rm{J}}{\rm{cm}^3}$', (txtx+0.35, 290), fontsize=14, color=(0,0,0))
    pics[3].annotate(r'Nickel', (0, 500), fontsize=16, color=(0,0,0))
    pics[3].set_xlabel(r'delay [ps]', fontsize=fsz)
    pics[3].set_ylim(250, 530)

    ###IRON TEMP###
    pics[4].plot(ftc[1][0],ftc[1][1], color=colors[0], lw=3.0)
    pics[4].plot(ftc[2][0],ftc[2][1], color=colors[2], lw=3.0)
    pics[4].plot(ftc[3][0],ftc[3][1], color=colors[5], lw=3.0)
    pics[4].scatter(np.array(f2td[0])-0.15,f2td[1], s=10, color=colors[0])
    pics[4].scatter(np.array(f3td[0])-0.1,f3td[1], s=10, color=colors[2])
    pics[4].scatter(np.array(f4td[0])-0.12,f4td[1], s=10, color=colors[5])
    pics[4].annotate(r'929', (txtx, 340), fontsize=fsz, color=colors[5])
    pics[4].annotate(r'639', (txtx, 300), fontsize=fsz, color=colors[2])
    pics[4].annotate(r'452', (txtx, 260), fontsize=fsz, color=colors[0])
    pics[4].annotate(r'$\frac{\rm{J}}{\rm{cm}^3}$', (txtx+0.35, 290), fontsize=14, color=(0,0,0))
    ...
    ###COBALT TEMP###
    pics[5].plot(ctc[1][0], ctc[1][1], color=colors[0], lw=3.0)
    pics[5].plot(ctc[2][0], ctc[2][1], color=colors[2], lw=3.0)
    pics[5].plot(ctc[3][0], ctc[3][1], color=colors[4], lw=3.0)
    pics[5].scatter(np.array(c2td[0])-0.1, c2td[1], s=10, color=colors[0])
    pics[5].scatter(np.array(c3td[0])-0.1, c3td[1], s=10, color=colors[2])
    pics[5].scatter(np.array(c4td[0])-0.1, c4td[1], s=10, color=colors[4])
    pics[5].annotate(r'733', (txtx, 330), fontsize=fsz, color=colors[4])
    pics[5].annotate(r'554', (txtx, 300), fontsize=fsz, color=colors[2])
    pics[5].annotate(r'306', (txtx, 270), fontsize=fsz, color=colors[0])
    pics[5].annotate(r'$\frac{\rm{J}}{\rm{cm}^3}$', (txtx+0.35, 300), fontsize=14, color=(0,0,0))
