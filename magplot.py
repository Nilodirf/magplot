...
def highflu(fsz, txtx):
    ...
    pics[3].plot(ntc[3][0], ntc[3][1], color=colors[4], lw=3.0)
    pics[3].plot(ntc[4][0], ntc[4][1], color=colors[6], lw=3.0)
    pics[3].plot(ntc[5][0], ntc[5][1], color=colors[8], lw=3.0)
    pics[3].scatter(np.array(n3td[0]), n3td[1], color=colors[2], s=10)
    pics[3].scatter(n4td[0], n4td[1], color=colors[4], s=10)
    pics[3].scatter(n5td[0], n5td[1], color=colors[6], s=10)
    pics[3].scatter(n6td[0], n6td[1], color=colors[8], s=10)
    ...
    pics[4].scatter(np.array(f5td[0])-0.12,f5td[1], s=10, color=colors[7])
